// Trainee top bar — console title, search, notifications, theme toggle, logout.
...
export default function TraineeTopbar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center gap-4 border-b border-line bg-white/90 px-6 py-3 backdrop-blur-sm dark:border-night-line dark:bg-night-surface/90">
      <div>
        ...
        <p className="text-sm font-bold text-ink dark:text-white">Learner Console</p>
      </div>
